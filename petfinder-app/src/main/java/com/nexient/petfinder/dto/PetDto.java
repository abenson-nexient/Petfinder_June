package com.nexient.petfinder.dto;
...
public class PetDto {
	...
	private String name, animal, age, sex, status, size, mix, description,
			contact;
	private BigInteger id;

	public static PetDto fromPetFinderPetRecord(PetfinderPetRecord petRecord) {
		if (petRecord == null)
